...
public class TarihiYerSayfa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tarihi_yer_sayfa);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        TextView textView9 = findViewById(R.id.yerBaslıkTxtView_fy);
                        textView9.setText(fy_menuad.get(Integer.parseInt(i)));
                        TextView textView = findViewById(R.id.yerTxtView_fy);
                        textView.setText(fy_menuaciklama.get(Integer.parseInt(i)));
                            StorageReference refst_fy=streference_fy.child("TarihiYerler/T"+i+".jpg");
                            try {
                                ...
                                refst_fy.getFile(dosya).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                                    ...
                                    public void onSuccess(FileDownloadTask.TaskSnapshot taskSnapshot) {
                                        ...
                                        ImageView imageView = findViewById(R.id.yerimageView_fy);
                       ...
                       if (i!=null){
                           TextView textView13 = findViewById(R.id.yerTxtView_fy);
